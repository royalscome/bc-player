 ...
 * @LastEditors: weiyang
 * @LastEditTime: 2023-09-29 23:04:39
 */
import { isgy, getElement } from "./util.js";
// const useCanavs = (canvasDom, videoId, line, column, needVideo, tag) => {
...
//     const videoDom = needVideo? getElement("video-tag", tag) : document.getElementById(videoId);
